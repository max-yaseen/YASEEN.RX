...
<html lang="en">
  ...
  <title>Tshake/redis.lua at master · TshAkETEAM/Tshake · GitHub</title>
  ...
  <meta name="request-id" content="11A0:2085:4DD33:A1680:5C38AAE0" data-pjax-transient>
  ...
  <meta name="octolytics-host" content="collector.githubapp.com" /><meta name="octolytics-app-id" content="github" /><meta name="octolytics-event-url" content="https://collector.githubapp.com/github-external/browser_event" /><meta name="octolytics-dimension-request_id" content="11A0:2085:4DD33:A1680:5C38AAE0" /><meta name="octolytics-dimension-region_edge" content="iad" /><meta name="octolytics-dimension-region_render" content="iad" />
...
<meta class="js-ga-set" name="dimension1" content="Logged Out">
    ...
    <meta name="js-proxy-site-detection-payload" content="YjAwODFhYjU1NGZlZTE5ZTdhYWNkYjBjYWJhNTQ4MDNkMDRkZjY2N2Y4MzBiY2U2MmU4ODdmY2IwODJjZTFjYXx7InJlbW90ZV9hZGRyZXNzIjoiMTA5LjEyNy43MS43IiwicmVxdWVzdF9pZCI6IjExQTA6MjA4NTo0REQzMzpBMTY4MDo1QzM4QUFFMCIsInRpbWVzdGFtcCI6MTU0NzIxNzYzMywiaG9zdCI6ImdpdGh1Yi5jb20ifQ==">
  ...
  <meta name="octolytics-dimension-user_id" content="22827974" /><meta name="octolytics-dimension-user_login" content="TshAkETEAM" /><meta name="octolytics-dimension-repository_id" content="130395998" /><meta name="octolytics-dimension-repository_nwo" content="TshAkETEAM/Tshake" /><meta name="octolytics-dimension-repository_public" content="true" /><meta name="octolytics-dimension-repository_is_fork" content="false" /><meta name="octolytics-dimension-repository_network_root_id" content="130395998" /><meta name="octolytics-dimension-repository_network_root_nwo" content="TshAkETEAM/Tshake" /><meta name="octolytics-dimension-repository_explore_github_marketplace_ci_cta_shown" content="false" />
    ...
    <link rel="canonical" href="https://github.com/TshAkETEAM/Tshake/blob/master/libs/redis.lua" data-pjax-transient>
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" data-scope-type="Repository" data-scope-id="130395998" data-scoped-search-url="/TshAkETEAM/Tshake/search" data-unscoped-search-url="/search" action="/TshAkETEAM/Tshake/search" accept-charset="UTF-8" method="get"><input name="utf8" type="hidden" value="&#x2713;" />
      <label class="form-control header-search-wrapper header-search-wrapper-jump-to position-relative d-flex flex-justify-between flex-items-center js-chromeless-input-container">
        <input type="text"
          ...
          aria-label="Search"
          data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations#csrf-token=//0a0eC+XEkD3R7ibge6ocHL+UDZTvV36SjD2TM1mEzFQbDXdoc+8Bdb+gPMLAUtvfJOTy+fwiMVxfWrFrc4bQ=="
          spellcheck="false"
          autocomplete="off"
          >
  ...
  <a tabindex="-1" class="no-underline d-flex flex-auto flex-items-center jump-to-suggestions-path js-jump-to-suggestion-path js-navigation-open p-2" href="">
    ...
    <div aria-hidden="true" class="border rounded-1 flex-shrink-0 bg-gray px-1 text-gray-light ml-1 f6 d-none d-on-nav-focus js-jump-to-badge-jump">
      ...
      <span class="d-inline-block ml-1 v-align-middle">↵</span>
        ...
        <a class="HeaderMenu-link no-underline mr-3" href="/login?return_to=%2FTshAkETEAM%2FTshake%2Fblob%2Fmaster%2Flibs%2Fredis.lua" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in">Sign&nbsp;in</a>
...
<div class="container new-discussion-timeline experiment-repo-nav  ">
  <div class="repository-content ">
    ...
    <a class="d-none js-permalink-shortcut" data-hotkey="y" href="/TshAkETEAM/Tshake/blob/d0a432f7bbe40922f1332bf26a1f4a1809d6a901/libs/redis.lua">Permalink</a>

    <!-- blob contrib key: blob_contributors:v21:8ba67521bf1ac8e2ccda787c7d1b4008 -->

        <div class="signup-prompt-bg rounded-1">
      <div class="signup-prompt p-4 text-center mb-4 rounded-1">
        <div class="position-relative">
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form action="/site/dismiss_signup_prompt" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="2ixOYSpPnA4qnjLzD3rcT7ahGeEnSjR36G82aQt/roggpp7MoWynheALa80RfagOf8zJp+wt6kRCfckCGcNNwA==" />
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left js-load-contents"
  data-contents-url="/TshAkETEAM/Tshake/ref-list/master/libs/redis.lua?source_action=show&amp;source_controller=blob">
  ...
  <div class="select-menu-modal-holder js-menu-content js-navigation-container" data-pjax>
    ...
    <include-fragment src="/TshAkETEAM/Tshake/contributors/master/libs/redis.lua" class="commit-tease commit-loader">
      <div>
...
<div class="file-header">
  ...
  <div class="file-actions">
    ...
    <div class="BtnGroup">
      <a id="raw-url" class="btn btn-sm BtnGroup-item" href="/TshAkETEAM/Tshake/raw/master/libs/redis.lua">Raw</a>
        <a class="btn btn-sm js-update-url-with-hash BtnGroup-item" data-hotkey="b" href="/TshAkETEAM/Tshake/blame/master/libs/redis.lua">Blame</a>
      <a rel="nofollow" class="btn btn-sm BtnGroup-item" href="/TshAkETEAM/Tshake/commits/master/libs/redis.lua">History</a>
    </div>
...
<table class="highlight tab-size js-file-line-container" data-tab-size="8">
      <tr>
        ...
        <td id="LC1" class="blob-code blob-code-inner js-file-line"><span class="pl-k">local</span> Redis <span class="pl-k">=</span> (<span class="pl-c1">loadfile</span> <span class="pl-s"><span class="pl-pds">&quot;</span>./libs/lua-redis.lua<span class="pl-pds">&quot;</span></span>)()</td>
      </tr>
      <tr>
        <td id="L2" class="blob-num js-line-number" data-line-number="2"></td>
        <td id="LC2" class="blob-code blob-code-inner js-file-line"><span class="pl-k">local</span> FakeRedis <span class="pl-k">=</span> (<span class="pl-c1">loadfile</span> <span class="pl-s"><span class="pl-pds">&quot;</span>./libs/fakeredis.lua<span class="pl-pds">&quot;</span></span>)()</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC4" class="blob-code blob-code-inner js-file-line"><span class="pl-k">local</span> params <span class="pl-k">=</span> {</td>
      </tr>
      <tr>
        <td id="L5" class="blob-num js-line-number" data-line-number="5"></td>
        <td id="LC5" class="blob-code blob-code-inner js-file-line">  host <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">&#39;</span>127.0.0.1<span class="pl-pds">&#39;</span></span>,</td>
      </tr>
      <tr>
        <td id="L6" class="blob-num js-line-number" data-line-number="6"></td>
        <td id="LC6" class="blob-code blob-code-inner js-file-line">  port <span class="pl-k">=</span> <span class="pl-c1">6379</span>,</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC9" class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span class="pl-c">--</span> Overwrite HGETALL</span></td>
      </tr>
      <tr>
        <td id="L10" class="blob-num js-line-number" data-line-number="10"></td>
        <td id="LC10" class="blob-code blob-code-inner js-file-line">Redis.<span class="pl-smi">commands</span>.<span class="pl-smi">hgetall</span> <span class="pl-k">=</span> Redis.<span class="pl-c1">command</span>(<span class="pl-s"><span class="pl-pds">&#39;</span>hgetall<span class="pl-pds">&#39;</span></span>, {</td>
      </tr>
      <tr>
        <td id="L11" class="blob-num js-line-number" data-line-number="11"></td>
        <td id="LC11" class="blob-code blob-code-inner js-file-line">  response <span class="pl-k">=</span> <span class="pl-k">function</span>(<span class="pl-smi">reply</span>, <span class="pl-smi">command</span>, ...)</td>
      </tr>
      <tr>
        <td id="L12" class="blob-num js-line-number" data-line-number="12"></td>
        <td id="LC12" class="blob-code blob-code-inner js-file-line">    <span class="pl-k">local</span> new_reply <span class="pl-k">=</span> { }</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC14" class="blob-code blob-code-inner js-file-line">    <span class="pl-k">return</span> new_reply</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC18" class="blob-code blob-code-inner js-file-line"><span class="pl-k">local</span> redis <span class="pl-k">=</span> <span class="pl-c1">nil</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC20" class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span class="pl-c">--</span> Won&#39;t launch an error if fails</span></td>
      </tr>
      <tr>
        <td id="L21" class="blob-num js-line-number" data-line-number="21"></td>
        <td id="LC21" class="blob-code blob-code-inner js-file-line"><span class="pl-k">local</span> ok <span class="pl-k">=</span> <span class="pl-c1">pcall</span>(<span class="pl-k">function</span>()</td>
      </tr>
      <tr>
        <td id="L22" class="blob-num js-line-number" data-line-number="22"></td>
        <td id="LC22" class="blob-code blob-code-inner js-file-line">  redis <span class="pl-k">=</span> Redis.<span class="pl-c1">connect</span>(params)</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC25" class="blob-code blob-code-inner js-file-line"><span class="pl-k">if</span> <span class="pl-k">not</span> ok <span class="pl-k">then</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC27" class="blob-code blob-code-inner js-file-line">  <span class="pl-k">local</span> fake_func <span class="pl-k">=</span> <span class="pl-k">function</span>()</td>
      </tr>
      <tr>
        <td id="L28" class="blob-num js-line-number" data-line-number="28"></td>
        <td id="LC28" class="blob-code blob-code-inner js-file-line">    <span class="pl-c1">print</span>(<span class="pl-s"><span class="pl-pds">&#39;</span><span class="pl-cce">\27</span>[31mCan<span class="pl-cce">\&#39;</span>t connect with Redis, install/configure it!<span class="pl-cce">\27</span>[39m<span class="pl-pds">&#39;</span></span>)</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC30" class="blob-code blob-code-inner js-file-line">  <span class="pl-c1">fake_func</span>()</td>
      </tr>
      <tr>
        <td id="L31" class="blob-num js-line-number" data-line-number="31"></td>
        <td id="LC31" class="blob-code blob-code-inner js-file-line">  fake <span class="pl-k">=</span> FakeRedis.<span class="pl-c1">new</span>()</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC33" class="blob-code blob-code-inner js-file-line">  <span class="pl-c1">print</span>(<span class="pl-s"><span class="pl-pds">&#39;</span><span class="pl-cce">\27</span>[31mRedis addr: <span class="pl-pds">&#39;</span></span><span class="pl-k">..</span>params.<span class="pl-smi">host</span><span class="pl-k">..</span><span class="pl-s"><span class="pl-pds">&#39;</span><span class="pl-cce">\27</span>[39m<span class="pl-pds">&#39;</span></span>)</td>
      </tr>
      <tr>
        <td id="L34" class="blob-num js-line-number" data-line-number="34"></td>
        <td id="LC34" class="blob-code blob-code-inner js-file-line">  <span class="pl-c1">print</span>(<span class="pl-s"><span class="pl-pds">&#39;</span><span class="pl-cce">\27</span>[31mRedis port: <span class="pl-pds">&#39;</span></span><span class="pl-k">..</span>params.<span class="pl-smi">port</span><span class="pl-k">..</span><span class="pl-s"><span class="pl-pds">&#39;</span><span class="pl-cce">\27</span>[39m<span class="pl-pds">&#39;</span></span>)</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC36" class="blob-code blob-code-inner js-file-line">  redis <span class="pl-k">=</span> <span class="pl-c1">setmetatable</span>({fakeredis<span class="pl-k">=</span><span class="pl-c1">true</span>}, {</td>
      </tr>
      <tr>
        <td id="L37" class="blob-num js-line-number" data-line-number="37"></td>
        <td id="LC37" class="blob-code blob-code-inner js-file-line">  __index <span class="pl-k">=</span> <span class="pl-k">function</span>(<span class="pl-smi">a</span>, <span class="pl-smi">b</span>)</td>
      </tr>
      <tr>
        <td id="L38" class="blob-num js-line-number" data-line-number="38"></td>
        <td id="LC38" class="blob-code blob-code-inner js-file-line">    <span class="pl-k">if</span> b <span class="pl-k">~=</span> <span class="pl-s"><span class="pl-pds">&#39;</span>data<span class="pl-pds">&#39;</span></span> <span class="pl-k">and</span> fake[b] <span class="pl-k">then</span></td>
      </tr>
      <tr>
        <td id="L39" class="blob-num js-line-number" data-line-number="39"></td>
        <td id="LC39" class="blob-code blob-code-inner js-file-line">      <span class="pl-c1">fake_func</span>(b)</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC41" class="blob-code blob-code-inner js-file-line">    <span class="pl-k">return</span> fake[b] <span class="pl-k">or</span> fake_func</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC47" class="blob-code blob-code-inner js-file-line"><span class="pl-k">return</span> redis</td>
      </tr>
</table>
  ...
  <details class="details-reset details-overlay BlobToolbar position-absolute js-file-line-actions dropdown d-none" aria-hidden="true">
    ...
    <details-menu>
      <ul class="BlobToolbar-dropdown dropdown-menu dropdown-menu-se mt-2">
        ...
        <li><a class="dropdown-item js-update-url-with-hash" id="js-view-git-blame" role="menuitem" href="/TshAkETEAM/Tshake/blame/d0a432f7bbe40922f1332bf26a1f4a1809d6a901/libs/redis.lua">View git blame</a></li>
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between pt-6 pb-2 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2019 <span title="0.14015s from unicorn-6d5f78457-mllf5">GitHub</span>, Inc.</li>
